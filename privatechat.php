	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-8 col-sm-7">
				<br />
		        <h3 class="text-center"><?php echo $token;?>Realtime One to One Chat App using Ratchet WebSockets with PHP Mysql - Online Offline Status - 8</h3>
		        <hr />
		        <br />
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var conn = new WebSocket('ws://localhost:8080?token=<?php echo to_user_id; ?>');
