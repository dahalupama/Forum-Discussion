...
def store():
    ...
    return xTrain, xTest, yTrain, yTest, xData, yData
...
xTrain, xTest, yTrain, yTest,xData, yData = store()
...
fScore, precision, recall, matrix = calcFScore(xTrain, yTrain, model, vectorizer)
