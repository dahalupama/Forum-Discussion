        ...
        <section class="content-section" id="portfolio">
            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="_creators/suman1.php" target="_blank">
                            <span class="caption">
                    ...
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="_creators/rupa.php" target="_blank">
                            ...
                            <img class="img-fluid" src="img/rupa.png" alt="" width="410" height="400">
                        </a>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="_creators/rupa.php" target="_blank">
                            ...
                            <img class="img-fluid" src="img/upama.png" alt="" width="410" height="400">
                        </a>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="_creators/rupa.php" target="_blank">
                            ...
                            <img class="img-fluid" src="img/tarjan.png" alt="" width="410" height="400">
                        </a>
                    </div>
