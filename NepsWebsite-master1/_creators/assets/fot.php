            ...
            <div class="row" id ="fot">
                ...
                <div class="col-sm-2">
                    ...
                    <ul>
                        ...
                        <li><a href="../forum.php">The NEPS Forum</a></li>
                        <li><a href="../hub.php">The NEPS Hub</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>About us</h5>
                    <ul>
                        <li><a href="suman.php">Suman mainali</a></li>
                        <li><a href="arpan.php">Arpan bastola</a></li>
                    </ul>
                </div>
                <div class="col-sm-2">
                    <h5>Support</h5>
