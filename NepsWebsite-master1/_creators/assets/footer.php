        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <ul>
                    ...
                    <li><a href="../forum.php">The fed Forum</a></li><br>
                    <li><a href="../hub.php">The fed Hub</a></li><br>
                </ul>
            </div>
            <div class="col-sm-2">
                <h5>About us</h5>
            ...
            <div class="col-sm-3">
                <div class="social-networks">
                    <a href="https://github.com/msaad1999/KLiK--PHP-coded-Social-Media-Website" class="twitter"><i
