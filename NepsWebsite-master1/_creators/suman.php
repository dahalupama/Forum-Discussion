...
<body>
    ...
    <section class="intro-section" style="background-image: url(img/suman-cover.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-md-1 col-lg-2"></div>
				<div class="col-md-10 col-lg-8">
					<div class="intro">
                                            <div class="profile-img"><img src="img/suman.JPG" alt=""></div>
                                            <h2><b>Suman Mainli</b></h2><br>
                                            
                                            <h4 class="font-yellow">Everything is fake</h4>
                                             
                                                
                                            <br><br>
						<ul class="social-icons">
							<li><a href="https://github.com/suman" target="_blank">
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-6">
					...
					<div class="line-progress margin-b-20" data-prog-percent=".85"><div></div>
                                            <p class="progress-title"><b>Creating games</b></p></div><br>

					<div class="line-progress margin-b-20" data-prog-percent=".70"><div></div>
                                            <p class="progress-title"><b>Breaking perfectly working code</b></p></div><br>
    ...
    <!--    <section class="content-section" id="portfolio">
          <div class="container">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://github.com/sumad">
                  <span class="caption">
                    <span class="caption-content">
                      <h2>NEPS</h2>
                  ...
                  <img class="img-fluid" src="img/Neps.png" alt="">
                </a>
              </div>
            </div>
          </div>
